...
heritage: main2 main3 main4 main5 main6 main7 clean
resume: resume0 resume1 resume2 resume3
clean: clean2
	rm -rf *.txt~ *.java~ Makefile~ *.class mypackage/*.class mypackage/*.java~
clean2:
	rm -rf pm/*.class pm/*.java~ others_heritage/*.java~ others_heritage/*.class paquets/*.class paquets/*.java~ paquets_autres/*.class paquets_autres/*.java~ abstraits/*.java~ abstraits/*.class vehicules/*.java~ vehicules/*.class batiments/*.java~ batiments/*.class
